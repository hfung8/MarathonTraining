...
function getRoutes(distance) {
  ...
  jQuery_3_1_1.ajax({
    ...
    filteredResults.forEach(function(element) {
      ...
      var url = "http://snippets.mapmycdn.com/routes/view/embedded/" + mapID + "?width=400&height=380&&line_color=E60f0bdb&rgbhex=DB0B0E&distance_markers=0&unit_type=imperial&map_mode=ROADMAP";
